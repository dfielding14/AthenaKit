...
def add_data(ad,add_bcc=True):
    ...
    ad.add_data_func('dens*vtot^2', lambda data : data('dens')*data('vtot')**2)
    ad.add_data_func('dens*velR^2', lambda data : data('dens')*data('velR')**2)
    ad.add_data_func('dens*velz^2', lambda data : data('dens')*data('velz')**2)
    ad.add_data_func('pmag*velR', lambda data : data('pmag')*data('velR'))
